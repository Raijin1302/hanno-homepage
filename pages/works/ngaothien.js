      ...
      <div style={{ display: 'grid', gap: '1.25rem' }}>
        ...
        <div className="grid-2">
          <div className="card-image" style={{ border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
            <Image src="/images/works/ngaothien_01.png" alt="ngaothien screenshot 1" fill className="image-cover" />
          </div>
          <div className="card-image" style={{ border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
            <Image src="/images/works/ngaothien_02.png" alt="ngaothien screenshot 2" fill className="image-cover" />
          </div>
        </div>
      </div>
    </Layout>
